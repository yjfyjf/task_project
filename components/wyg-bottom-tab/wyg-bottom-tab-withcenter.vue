	...
	export default {
		...
		data() {
			return {
				curTab:1,
				tabList:[
					{id:1,name:"首页",imgOff:"../../static/img/bottom-tab-img/icon_01.png",imgOn:"../../static/img/bottom-tab-img/icon_01_f.png"},
					{id:2,name:"分类",imgOff:"../../static/img/bottom-tab-img/icon_02.png",imgOn:"../../static/img/bottom-tab-img/icon_02_f.png"},
					{id:3,name:"购物车",imgOff:"../../static/img/bottom-tab-img/icon_03.png",imgOn:"../../static/img/bottom-tab-img/icon_03_f.png","center":true},
					{id:4,name:"个人中心",imgOff:"../../static/img/bottom-tab-img/icon_04.png",imgOn:"../../static/img/bottom-tab-img/icon_04_f.png"},
					{id:5,name:"个人中心",imgOff:"../../static/img/bottom-tab-img/icon_04.png",imgOn:"../../static/img/bottom-tab-img/icon_04_f.png"}
				]
