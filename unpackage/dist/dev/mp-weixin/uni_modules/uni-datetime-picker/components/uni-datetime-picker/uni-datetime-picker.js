  ...
  methods: {
    ...
    confirmSingleChange() {
      ...
      if (this.end) {
        ...
        [endDate, endTime] = endString && endString.split(" ");
    ...
    confirmRangeChange() {
      ...
      if (this.end) {
        this.end;
        if (typeof this.end === "number") {
          uni_modules_uniDatetimePicker_components_uniDatetimePicker_util.getDateTime(this.end, this.hideSecond);
        }
      ...
      if (!this.hasTime) {
        ...
        if (startDateLaterRangeStartDate) {
          ...
          this.tempRange.startTime = uni_modules_uniDatetimePicker_components_uniDatetimePicker_util.getDefaultSecond(this.hideSecond);
        }
        ...
        if (startDateLaterRangeEndDate) {
          ...
          this.tempRange.endTime = uni_modules_uniDatetimePicker_components_uniDatetimePicker_util.getDefaultSecond(this.hideSecond);
        }
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    C: common_vendor.sr("pcSingle", "0d454372-4"),
    ...
    ad: common_vendor.sr("left", "0d454372-8"),
    ...
    ah: common_vendor.sr("right", "0d454372-9"),
    ...
    at: common_vendor.sr("mobile", "0d454372-10"),
